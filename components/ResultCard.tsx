          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {result.knowledgeMap.prerequisites.map((prereq, index) => (
                <span
                  key={index}
                  className="px-4 py-2 bg-gradient-to-r from-gray-100 to-slate-100 text-gray-700 rounded-full text-sm font-medium border border-gray-200"
                >
                  {prereq}
                </span>
              ))}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {step.resources.map((resource, resourceIndex) => (
                    <span
                      key={resourceIndex}
                      className="px-3 py-1 bg-gradient-to-r from-emerald-50 to-cyan-50 text-emerald-700 rounded-full text-xs font-medium border border-emerald-200"
                    >
                      {resource}
                    </span>
                  ))}
